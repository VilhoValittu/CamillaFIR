...
TRANSLATIONS = {
    'en': {
        ...
        'lvl_auto': "Automatic",
        'lvl_man': "Manual dB",
        'lvl_target_db': "Manual Target (dB)", # Fixed key
        'lvl_algo': "Algo",
        'algo_mean': "Average",
        'algo_median': "Median",
    ...
    'fi': {
        ...
        'lvl_target_db': "Manuaalinen tavoite (dB)", # Fixed key
        'lvl_algo': "Algoritmi",
        'algo_mean': "Keskiarvo",
        ...
        'rep_reg': "Regularization (Kirkeby):",
        ...
        'guide_reg_title': "❓ Opas: Regularization (Kirkeby)",
