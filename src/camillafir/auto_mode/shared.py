...
AUTO_MODE_SYNTH_TARGET_BASS_COMP_FRAC = 0.25 # basson määrä
AUTO_MODE_SYNTH_TARGET_BASS_COMP_REF_DB = 8.0
AUTO_MODE_SYNTH_TARGET_TILT_COMP_FRAC = 0.30
AUTO_MODE_SYNTH_TARGET_HF_COMP_FRAC = 0.25
...
AUTO_MODE_OPTUNA_CONSTRAINTS_ZERO_FEASIBLE_FALLBACK = False
...
AUTO_MODE_RANK_SCORE_BIAS = 25.65 #pisteiden kerroin
    ...
    def from_base_data(cls, base_data: dict | None) -> "AutoModeConfig":
        ...
        return cls(
            ...
            optuna_cross_study_seeds=_auto_safe_bool(
                data.get("auto_mode_optuna_cross_study_seeds", AUTO_MODE_OPTUNA_CROSS_STUDY_SEEDS),
                AUTO_MODE_OPTUNA_CROSS_STUDY_SEEDS,
            ),
            optuna_cross_study_seeds_top_n=max(
                1,
                _auto_safe_int(
                    data.get("auto_mode_optuna_cross_study_seeds_top_n", AUTO_MODE_OPTUNA_CROSS_STUDY_SEEDS_TOP_N),
                    AUTO_MODE_OPTUNA_CROSS_STUDY_SEEDS_TOP_N,
                ),
            ),
            optuna_pruning_enabled=_auto_safe_bool(
                data.get("auto_mode_optuna_pruning_enabled", AUTO_MODE_OPTUNA_PRUNING_ENABLED),
                AUTO_MODE_OPTUNA_PRUNING_ENABLED,
            ),
            optuna_pruning_n_startup=max(
                1,
                _auto_safe_int(
                    data.get("auto_mode_optuna_pruning_n_startup", AUTO_MODE_OPTUNA_PRUNING_N_STARTUP),
