...
try:
    from .camillafir_wav_window import ir_wav_to_complex_response as _wav_ir_to_complex
except Exception:
    try:
        from src.camillafir.io.camillafir_wav_window import ir_wav_to_complex_response as _wav_ir_to_complex
    except Exception:
