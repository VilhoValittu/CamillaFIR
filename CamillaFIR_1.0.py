...
# --- MATPLOTLIB SETUP ---
import matplotlib
matplotlib.use('Agg') # Force non-interactive backend for web GUI
...
def main():
    ...
    inputs_list = [
        ...
        input("Max Boost (dB)", value=5.0, type=FLOAT, name='max_boost'),
