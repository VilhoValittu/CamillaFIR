# Stability and Reproducibility (v3.3.0)
...
Release `v3.3.0` (2026-03-01) keeps this deterministic model and adds stronger startup validation in CI.
...
1. Use the same app version (`v3.3.0` or newer pinned release).
