...
description: "Automatic FIR filter maker / generator for REW exports, built-in sweep measurements, and WAV/IR captures. Exports WAV FIR filters and companion config files for CamillaDSP, Roon, Equalizer APO and more."
permalink: /
---
...
<meta property="og:description" content="Automatic FIR filter maker / generator for REW exports, built-in sweep measurements, and WAV/IR captures. Exports WAV FIR filters and companion config files for CamillaDSP, Roon, Equalizer APO and more." />
...
<meta name="twitter:description" content="Automatic FIR filter maker / generator for REW exports, built-in sweep measurements, and WAV/IR captures. Exports WAV FIR filters and companion config files for CamillaDSP, Roon, Equalizer APO and more." />
...
<script type="application/ld+json">
{
  ...
  "description":"Automatic FIR filter maker / generator for REW exports, built-in sweep measurements, and WAV/IR captures. Exports WAV FIR filters and companion config files for CamillaDSP, Roon, Equalizer APO and more. Supports mixed-phase and linear-phase workflows.",
  "featureList": "Automatic FIR filter maker, Room correction filter generator, Mixed-phase FIR design, built-in measurement workflow, REW and WAV/IR integration",
...
CamillaFIR is an **automatic FIR filter maker / generator** that turns **REW exports, built-in sweep measurements, and WAV/IR captures** into **convolution FIR filters** you can load into:
...
- Converts measurement data (for example REW exports, built-in sweep captures, or WAV/IR imports) into **FIR correction filters**
...
- AUTO mode can rank candidates with harmonic-aware boost penalties and IACC-aware stereo checks
...
1. Measure your speakers / room with **REW** or the built-in CamillaFIR measurement workflow
2. Export or save measurement data (for REW TXT include magnitude + phase; for REW WAV use `Mono`, `float32`, `Normalise`, `Place t=0 (256)`)
